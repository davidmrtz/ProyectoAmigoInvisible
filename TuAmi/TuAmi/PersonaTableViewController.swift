...
class PersonaTableViewController:
    ...
    var toDoItemsSorteo:NSMutableArray = NSMutableArray()
    ...
    let toDoItemList:NSMutableArray? = userDefaults.objectForKey(nombreArray) as? NSMutableArray
        ...
        let toDoItemListSorteo:NSMutableArray? = userDefaultsSorteo.objectForKey("Sorteo") as? NSMutableArray
    
    if (toDoItemListSorteo != nil) {
    toDoItemsSorteo=toDoItemListSorteo!
    }
    ...
    detailPerViewController.todoData = toDoItems.objectAtIndex(indexPath.row) as! NSDictionary
        ...
        detailPerViewController.todoData = toDoItemsSorteo.objectAtIndex(indexPath.row) as! NSDictionary
